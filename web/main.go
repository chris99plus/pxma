...
func main() {
	...
	options := []rp.Option{
		...
		// rp.WithSigningAlgsFromDiscovery("https://fairbytesauth.ciamlogin.com/fairbytesauth.onmicrosoft.com/v2.0/.well-known/openid-configuration?appid=36dabb70-15ff-436d-bf99-0c86cce5a000"),
	}
	if clientSecret == "" {
